...
(function() {
  var Ti_context, address_field_hash, array_field_hash, bytes_field_hash, class_prepare, et_list_sign, is_composite_type, is_defined_number_or_byte_type, is_not_defined_type, is_number_type, module, op, type_resolve, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4;
  ...
  Ti_context = (function() {
    ...
    Ti_context.prototype.type_proxy = function(cls) {
      var k, ret, _ref5, _ref6;
      ret = new Type("struct");
      _ref5 = cls._prepared_field2type;
      for (k in _ref5) {
        v = _ref5[k];
        if ((_ref6 = v.main) !== "function2" && _ref6 !== "function2_pure") {
          continue;
        }
        ret.field_hash[k] = v;
      }
  ...
  this.gen = function(ast_tree, opt) {
    ...
    walk = function(root, ctx) {
      var a, arg, class_decl, complex_type, ctx_nest, decl, expected, f, field_hash, field_type, idx, k, name, nest_list, nest_type, offset, real, root_type, t, tuple_value, type, _aa, _ab, _len10, _len11, _len12, _len13, _len14, _len15, _len16, _len17, _len18, _len19, _len5, _len6, _len7, _len8, _len9, _n, _o, _p, _q, _r, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref20, _ref21, _ref22, _ref23, _ref24, _ref5, _ref6, _ref7, _ref8, _ref9, _s, _t, _u, _v, _w, _x, _y, _z;
      switch (root.constructor.name) {
        ...
        case "Ret_multi":
          _ref15 = root.t_list;
          for (idx = _t = 0, _len11 = _ref15.length; _t < _len11; idx = ++_t) {
            v = _ref15[idx];
        ...
        case "Class_decl":
          ...
          _ref16 = root._prepared_field2type;
          for (k in _ref16) {
            v = _ref16[k];
        ...
        case "Fn_decl_multiret":
          ...
          for (k = _u = 0, _len12 = _ref17.length; _u < _len12; k = ++_u) {
            name = _ref17[k];
        ...
        case "Ternary":
          ...
          return root.type;
        case "New":
          _ref18 = root.arg_list;
          for (_v = 0, _len13 = _ref18.length; _v < _len13; _v++) {
            arg = _ref18[_v];
            walk(arg, ctx);
          }
          return root.type;
        case "Tuple":
          ...
          _ref21 = root.type.nest_list;
          for (idx = _y = 0, _len16 = _ref21.length; _y < _len16; idx = ++_y) {
            v = _ref21[idx];
        ...
        case "Array_init":
          ...
          _ref23 = root.list;
          for (_aa = 0, _len18 = _ref23.length; _aa < _len18; _aa++) {
            v = _ref23[_aa];
    ...
    walk = function(root, ctx) {
      var a, a_type_list, arg, b, b_type_list, bruteforce_a, bruteforce_b, bruteforce_ret, class_decl, complex_type, ctx_nest, decl, expected, expected_type, f, field_hash, field_type, filter_found_list, found_list, i, idx, k, list, name, nest_list, nest_type, new_type, offset, real, ret, ret_type_list, root_type, t, tuple, tuple_value, type, _aa, _ab, _ac, _ad, _ae, _af, _ag, _ah, _ai, _aj, _ak, _al, _am, _an, _len10, _len11, _len12, _len13, _len14, _len15, _len16, _len17, _len18, _len19, _len20, _len21, _len22, _len23, _len24, _len25, _len26, _len27, _len28, _len29, _len30, _len31, _len5, _len6, _len7, _len8, _len9, _n, _o, _p, _q, _r, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref5, _ref6, _ref7, _ref8, _ref9, _s, _t, _u, _v, _w, _x, _y, _z;
      switch (root.constructor.name) {
        case "Var":
          return root.type = type_spread_left(root.type, ctx.check_id(root.name), ctx);
        case "Const":
        ...
        case "Var_decl_multi":
          ...
          _ref14 = root.list;
          for (_ac = 0, _len20 = _ref14.length; _ac < _len20; _ac++) {
            decl = _ref14[_ac];
            ctx.var_hash[decl.name] = decl.type;
          }
          return null;
        ...
        case "Ret_multi":
          _ref17 = root.t_list;
          for (idx = _af = 0, _len23 = _ref17.length; _af < _len23; idx = ++_af) {
            v = _ref17[idx];
            v.type = type_spread_left(v.type, ctx.parent_fn.type_o.nest_list[idx], ctx);
            expected = ctx.parent_fn.type_o.nest_list[idx];
            real = v.type;
        ...
        case "Class_decl":
          ...
          ctx_nest = ctx.mk_nest();
          ctx_nest.current_class = root;
          _ref18 = root._prepared_field2type;
          for (k in _ref18) {
            v = _ref18[k];
            ctx_nest.var_hash[k] = v;
          }
        ...
        case "Fn_decl_multiret":
          ...
          for (k = _ag = 0, _len24 = _ref19.length; _ag < _len24; k = ++_ag) {
            name = _ref19[k];
            type = root.type_i.nest_list[k];
            ctx_nest.var_hash[name] = type;
          }
        ...
        case "New":
          ...
          for (_ah = 0, _len25 = _ref20.length; _ah < _len25; _ah++) {
            arg = _ref20[_ah];
            walk(arg, ctx);
          }
          return root.type;
        case "Tuple":
          ...
          for (idx = _ak = 0, _len28 = _ref23.length; _ak < _len28; idx = ++_ak) {
            v = _ref23[idx];
            tuple_value = root.list[idx];
            tuple_value.type = type_spread_left(tuple_value.type, v, ctx);
          }
        ...
        case "Array_init":
          ...
          _ref25 = root.list;
          for (_am = 0, _len30 = _ref25.length; _am < _len30; _am++) {
            v = _ref25[_am];
            nest_type = type_spread_left(nest_type, v.type, ctx);
          }
          _ref26 = root.list;
