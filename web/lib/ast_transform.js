(function() {
  var add_router, address_calls_converter, ass_op_unpack, call_storage_and_oplist_inject, collect_fn_decl, decl_storage_and_oplist_inject, erc20_converter, erc721_converter, ercs_translate, fix_missing_emit, fix_modifier_order, for3_unpack, inheritance_unpack, intrinsics_converter, math_funcs_convert, modifier_unpack, module, replace_enums_by_nat, require_distinguish, return_op_list_count, router_collector, translate_type, translate_var_name, var_translate;
  ...
  collect_fn_decl = require("./transforms/collect_fn_decl").collect_fn_decl;
  ...
  this.post_ti = function(root, opt) {
    var func_decls, router_func_list;
    if (opt == null) {
      opt = {};
    }
    if (opt.router == null) {
