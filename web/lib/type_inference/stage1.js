(function() {
  ...
  this.walk = function(root, ctx) {
    var a, arg, class_decl, complex_type, ctx_nest, decl, expected, f, field_map, field_type, i, idx, k, name, nest_list, nest_type, offset, real, root_type, t, tuple_value, type, v, _i, _j, _k, _l, _len, _len1, _len10, _len11, _len12, _len13, _len14, _len15, _len16, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _s, _t, _u, _v, _w, _x, _y;
    switch (root.constructor.name) {
      ...
      case "Ret_multi":
        _ref11 = root.t_list;
        for (idx = _p = 0, _len7 = _ref11.length; _p < _len7; idx = ++_p) {
          v = _ref11[idx];
      ...
      case "Fn_decl_multiret":
        ...
        for (k = _q = 0, _len8 = _ref13.length; _q < _len8; k = ++_q) {
          name = _ref13[k];
      ...
      case "New":
        ...
        for (_s = 0, _len10 = _ref15.length; _s < _len10; _s++) {
          arg = _ref15[_s];
          ctx.walk(arg, ctx);
        }
        return root.type;
      case "Tuple":
        _ref16 = root.list;
        for (_t = 0, _len11 = _ref16.length; _t < _len11; _t++) {
          v = _ref16[_t];
          ctx.walk(v, ctx);
        }
        nest_list = [];
        _ref17 = root.list;
        for (_u = 0, _len12 = _ref17.length; _u < _len12; _u++) {
          v = _ref17[_u];
        ...
        for (idx = _v = 0, _len13 = _ref18.length; _v < _len13; idx = ++_v) {
          v = _ref18[idx];
